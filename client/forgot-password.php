...
if (filter_var($mymailid, FILTER_VALIDATE_EMAIL)) {
			$userdetils = runQuery("SELECT * FROM user WHERE email = '$mymailid'");
			...
			$userdetils = runQuery("SELECT * FROM user WHERE mobile = '$mymailid'");
						...
						if(!empty($_POST['confirm_pass'])){
							if($_POST['new_pass']===$_POST['confirm_pass']){
								...
								$id = $_POST['id'];
									...
									$insert_sql = "update user set password = '".$newpass."' where ID = $id";
