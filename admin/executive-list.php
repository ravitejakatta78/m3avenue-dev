...
<!-- end:: Subheader -->
			...
			<div class="kt-portlet kt-portlet--mobile">
					...
					<div class="kt-portlet__head">
						<div class="kt-portlet__head-label">
							<h3 class="kt-portlet__head-title">Add Executive</h3>
						</div>
					</div>
		 ...
		 <form  method="post" action="" enctype="multipart/form-data" autocomplete="off" > 
					...
					<div class="form-group row">
                        ...
                        <div class="col-3"> 			
							<select class="form-control" name="employee">
								...
								<?php $employeearray = runloopQuery("select ID,unique_id from employee order by ID desc");
									foreach($employeearray as $employeid){ ?>
											<option value="<?php echo $employeid['ID'];?>"><?php echo $employeid['unique_id'];?></option> 
									<?php } ?>
							</select>
                        </div>
					</div>
		    ...
		    <div class="kt-portlet kt-portlet--mobile"> 
						<div class="kt-portlet__head">
							<div class="kt-portlet__head-label">
								<div class="col-10">
								<h3 class="kt-portlet__head-title">Executive List</h3>
								</div> 
								<a href="csv-executive.php" class="btn btn-primary pull-right" >Download</a> 
							</div>
						</div>     
		<div class="kt-portlet__body">
	...
	<br><?php echo  $row['user_role']=='manager' ? ucwords($row['user_role']) : '';?></td>
	...
	<td><?php echo $row["location"];?></td> 
	 <td><label class="switch">
	  <input type="checkbox" <?php if($row['status']=='1'){ echo 'checked';}?> onChange="changestatus('executive',<?php echo $row['ID'];?>);">
