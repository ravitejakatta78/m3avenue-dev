	...
	<div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
			    ...
			    <div class="kt-portlet kt-portlet--mobile">
                    ...
                    <div class="kt-portlet__head">
				    	<div class="kt-portlet__head-label">
					    	<h3 class="kt-portlet__head-title">Edit Executive</h3>
					    </div>
			    	</div>
		 ...
		 <form  method="post" action="" enctype="multipart/form-data" autocomplete="off" >
					...
					<div class="form-group row">
						...
						<label for="example-text-input" class="col-3 col-form-label">Employee</label>
                        <div class="col-3"> 			
							<select class="form-control" name="employee">
								...
								<?php $employeearray = runloopQuery("select ID,unique_id from employee order by ID desc");
									foreach($employeearray as $employeid){ ?>
											<option value="<?php echo $employeid['ID'];?>" <?php if($executivedetails['employee_id']==$employeid['ID']){ echo 'selected';}?>><?php echo $employeid['unique_id'];?></option> 
									<?php } ?>
							</select>
                        </div>
                    </div>
