...
if (filter_var($mymailid, FILTER_VALIDATE_EMAIL)) {
			$userdetils = runQuery("SELECT * FROM employee WHERE email = '$mymailid'");
			 ...
			 Forgot password<br/>
			  ...
			  <br /><br />
			  <a href='".SITE_URL."team/forgot-password.php?type=".encrypt('forgotpass')."&id=".encrypt($userdetils['ID'])."'>Click HERE to change password :)</a>
			  <br /><br />
			  Thanks";
			  $to = $userdetils['email'];
			...
			$userdetils = runQuery("SELECT * FROM employee WHERE mobile = '$mymailid'");
